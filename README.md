...
- [Funcionalidades](v5/PLAN_FEATURES.md): Validaciones, AI Notes, Recetas y Turnos inteligentes están publicadas, con navegación recíproca. Home usa tarjetas completas clickeables y también menciona la gestión de turnos en beneficios. Runtime público `1ea8850`, con las tres funcionalidades ilustradas y Validaciones A refinada; [publicación y rollback](docs/releases/2026-09-20-three-feature-illustrations.md).
...
Runtime `1ea8850`: AI Notes, Recetas y Turnos con textos anteriores e ilustraciones nuevas, Validaciones A refinada, navegación desktop y megamenú mobile, calculadora C y URLs limpias. [Publicación vigente y rollback](docs/releases/2026-09-20-three-feature-illustrations.md).
